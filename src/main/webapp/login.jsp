...
<button type="submit" id="btn_login" >登录</button>
    <jsp:useBean id="users" scope="session" class="com.Servlet.LoginServlet">
        <jsp:setProperty name="users" property="username" value="user"/>
        <jsp:setProperty name="users" property="password" value="psd"/>
    </jsp:useBean>
